...
confirmed — and it's one of the ten conditions that must be met before our CAS can be
issued, and therefore before we can apply for our visa. We're working through the
remaining conditions on our side, so membership is really the one piece left outside our
control.
...
- **Commitment fee — deliberately NOT claimed as paid.** Imanol can't pay his until ~end
  of this week at the earliest, so the email only says "working through the remaining
  conditions" — true, and no overstatement. (Lu's is paid.) Once yours is paid you *could*
  add "the commitment fee is settled," but it isn't needed.
...
- **Visa cost is factually checked:** standard ≈ £558; Priority ("express", 5 working days)
  ≈ £1,058 — i.e. **~1.9×, "roughly double" is accurate**; Super Priority (next day) ≈
  £1,558 (~3×). Full breakdown + sources in `../analysis/honest-take.md`.
